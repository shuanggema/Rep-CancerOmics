...
######## input ########
setwd("/Users/name/Desktop/TCGA-2021/Data/TCGA_LUSC/Clinic/clinical.cart.2021-09-04")
...
Final_demo <- Final_demo[!Final_demo$time == "'--",] #delete 6 subjects missing death time or loss to follow-up time
